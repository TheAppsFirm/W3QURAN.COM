...
// SEO data for known views
const VIEW_SEO = {
  listen: { title: 'Listen to Quran - w3Quran', desc: 'Listen to the Holy Quran with multiple reciters including Al-Afasy, Abdul Basit, and more.' },
  names: { title: '99 Names of Allah - w3Quran', desc: 'Explore the 99 beautiful names of Allah with meanings, audio pronunciation, and details.' },
  quiz: { title: 'Quran Quiz - w3Quran', desc: 'Test your knowledge of the Holy Quran with interactive quizzes and challenges.' },
  prayer: { title: 'Prayer Times - w3Quran', desc: 'Accurate prayer times with Qibla direction based on your location.' },
  daily: { title: 'Daily Verse - w3Quran', desc: 'Read your daily verse from the Holy Quran with translation and reflection.' },
  stats: { title: 'Reading Statistics - w3Quran', desc: 'Track your Quran reading progress, streaks, and achievements.' },
  kids: { title: 'Kids Mode - w3Quran', desc: 'Fun and interactive Quran learning for kids with animated duas and engaging activities.' },
  privacy: { title: 'Privacy Policy - w3Quran', desc: 'Privacy policy for w3Quran application.' },
  terms: { title: 'Terms of Service - w3Quran', desc: 'Terms of service for w3Quran application.' },
  settings: { title: 'Settings - w3Quran', desc: 'Customize your w3Quran reading experience.' },
  donate: { title: 'Donate - w3Quran', desc: 'Support the w3Quran project.' },
};

...
// Feature-specific data modules removed from barrel to reduce initial bundle.
// These are lazy-loaded by their respective components via direct imports:
// - treebankData.js (313KB) → import from './treebank/index' in TreebankAnalysis.jsx
// - propheticLocations.js (104KB) → import from './propheticLocations' in PropheticMap.jsx
// - gamificationSystem.js → import from './gamificationSystem' in GamificationHub.jsx
// - familyStorage.js → import from './familyStorage' in FamilyCircle.jsx
// - meditationSessions.js → import from './meditationSessions' in HeartbeatMeditation.jsx
// - natureParallels.js → import from './natureParallels' in LivingVisualization.jsx
// - quranGuidance.js → import from './quranGuidance' in QuranCompanionAI.jsx
// - timeCapsuleStorage.js → import from './timeCapsuleStorage' in TimeCapsule.jsx

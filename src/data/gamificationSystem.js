...
export const ACHIEVEMENTS = {
  ...
  first_verse: {
    ...
    descriptionAr: 'اقرأ أول آية لك',
    descriptionUr: 'اپنی پہلی آیت پڑھیں',
    icon: 'BookOpen',
    color: '#10B981',
    xp: 10,
    category: 'reading',
  ...
  surah_complete: {
    ...
    descriptionAr: 'أكمل قراءة سورة كاملة',
    descriptionUr: 'ایک مکمل سورت پڑھیں',
    icon: 'Award',
    color: '#3B82F6',
    xp: 25,
    category: 'reading',
  ...
  juz_complete: {
    ...
    descriptionAr: 'أكمل قراءة جزء كامل',
    descriptionUr: 'ایک مکمل پارہ پڑھیں',
    icon: 'Trophy',
    color: '#F59E0B',
    xp: 100,
    category: 'reading',
  ...
  quran_complete: {
    ...
    descriptionAr: 'أكمل قراءة القرآن الكريم كاملاً',
    descriptionUr: 'پورا قرآن پاک مکمل کریں',
    icon: 'Crown',
    color: '#FFD700',
    xp: 1000,
    category: 'reading',
  ...
  streak_3: {
    ...
    descriptionAr: 'حافظ على سلسلة قراءة لمدة 3 أيام',
    descriptionUr: '3 دن مسلسل تلاوت کریں',
    icon: 'Fire',
    color: '#EF4444',
    xp: 15,
    category: 'streak',
  ...
  streak_7: {
    ...
    nameUr: 'ہفتے کا مجاہد',
    description: 'Maintain a 7-day reading streak',
    descriptionAr: 'حافظ على سلسلة قراءة لمدة 7 أيام',
    descriptionUr: '7 دن مسلسل تلاوت کریں',
    icon: 'Fire',
    color: '#F59E0B',
    xp: 30,
    category: 'streak',
  ...
  streak_30: {
    ...
    descriptionAr: 'حافظ على سلسلة قراءة لمدة 30 يوماً',
    descriptionUr: '30 دن مسلسل تلاوت کریں',
    icon: 'Fire',
    color: '#8B5CF6',
    xp: 150,
    category: 'streak',
  ...
  streak_100: {
    ...
    descriptionAr: 'حافظ على سلسلة قراءة لمدة 100 يوم',
    descriptionUr: '100 دن مسلسل تلاوت کریں',
    icon: 'Star',
    color: '#FFD700',
    xp: 500,
    category: 'streak',
  ...
  ai_seeker: {
    ...
    descriptionAr: 'استخدم المرشد الذكي 10 مرات',
    descriptionUr: 'AI ساتھی کو 10 مرتبہ استعمال کریں',
    icon: 'HeartHandshake',
    color: '#14B8A6',
    xp: 25,
    category: 'features',
  ...
  explorer: {
    ...
    descriptionAr: 'اكتشف 5 مواقع على الخريطة النبوية',
    descriptionUr: 'نبوی نقشے پر 5 مقامات دریافت کریں',
    icon: 'Globe3D',
    color: '#0EA5E9',
    xp: 30,
    category: 'features',
  ...
  world_traveler: {
    ...
    descriptionAr: 'افتح جميع المواقع على الخريطة النبوية',
    descriptionUr: 'نبوی نقشے پر سب مقامات کھولیں',
    icon: 'Map',
    color: '#6366F1',
    xp: 100,
    category: 'features',
  ...
  meditator: {
    ...
    descriptionAr: 'أكمل 5 جلسات تأمل',
    descriptionUr: '5 مراقبے مکمل کریں',
    icon: 'Breath',
    color: '#8B5CF6',
    xp: 40,
    category: 'features',
  ...
  time_keeper: {
    ...
    nameUr: 'یادوں کا محافظ',
    description: 'Create 5 time capsules',
    descriptionAr: 'أنشئ 5 كبسولات زمنية',
    descriptionUr: '5 ٹائم کیپسول بنائیں',
    icon: 'Capsule',
    color: '#F472B6',
    xp: 25,
    category: 'features',
  ...
  voice_master: {
    ...
    descriptionAr: 'استخدم 20 أمراً صوتياً',
    descriptionUr: '20 آواز کے احکامات استعمال کریں',
    icon: 'Speech',
    color: '#22C55E',
    xp: 30,
    category: 'features',
  ...
  first_memorize: {
    ...
    descriptionAr: 'احفظ أول آية لك',
    descriptionUr: 'اپنی پہلی آیت حفظ کریں',
    icon: 'Brain',
    color: '#EC4899',
    xp: 15,
    category: 'hifz',
  ...
  memorize_10: {
    ...
    name: 'Growing Memory',
    nameAr: 'ذاكرة نامية',
    nameUr: 'بڑھتا ہوا حافظہ',
    description: 'Memorize 10 verses',
    descriptionAr: 'احفظ 10 آيات',
    descriptionUr: '10 آیات حفظ کریں',
    icon: 'Brain',
    color: '#8B5CF6',
    xp: 50,
    category: 'hifz',
  ...
  memorize_100: {
    ...
    descriptionAr: 'احفظ 100 آية',
    descriptionUr: '100 آیات حفظ کریں',
    icon: 'Brain',
    color: '#F59E0B',
    xp: 200,
    category: 'hifz',
  ...
  family_leader: {
    ...
    name: 'Family Leader',
    nameAr: 'قائد العائلة',
    nameUr: 'خاندان کا سربراہ',
    description: 'Create a family circle',
    descriptionAr: 'أنشئ حلقة عائلية',
    descriptionUr: 'خاندانی حلقہ بنائیں',
    icon: 'Family',
    color: '#F59E0B',
    xp: 20,
    category: 'social',
  ...
  generous_sharer: {
    ...
    descriptionAr: 'شارك 10 آيات',
    descriptionUr: '10 آیات شیئر کریں',
    icon: 'Share',
    color: '#10B981',
    xp: 25,
    category: 'social',
  ...
  first_listen: {
    ...
    descriptionAr: 'استمع إلى سورة كاملة',
    descriptionUr: 'ایک مکمل سورت سنیں',
    icon: 'Headphones',
    color: '#0EA5E9',
    xp: 10,
    category: 'listening',
  ...
  listen_10: {
    ...
    nameAr: 'مستمع مخلص',
    nameUr: 'پکا سننے والا',
    description: 'Listen to 10 complete surahs',
    descriptionAr: 'استمع إلى 10 سور كاملة',
    descriptionUr: '10 مکمل سورتیں سنیں',
    icon: 'Headphones',
    color: '#6366F1',
    xp: 50,
    category: 'listening',
  ...
  listen_juz: {
    ...
    descriptionAr: 'استمع إلى جزء كامل',
    descriptionUr: 'ایک مکمل پارہ سنیں',
    icon: 'Music',
    color: '#F59E0B',
    xp: 100,
    category: 'listening',
...
export const CHALLENGE_TEMPLATES = [
  {
    ...
    descriptionAr: 'اقرأ {target} آيات اليوم',
    descriptionUr: 'آج {target} آیات پڑھیں',
    icon: 'BookOpen',
    color: '#10B981',
    targets: [5, 10, 20, 30],
  ...
  },
  {
    ...
    descriptionAr: 'أكمل جلسة تأمل',
    descriptionUr: 'ایک مراقبہ مکمل کریں',
    icon: 'Breath',
    color: '#8B5CF6',
    targets: [1],
    xpReward: [15],
  },
  {
    ...
    descriptionAr: 'قم بزيارة {target} موقع على الخريطة',
    descriptionUr: 'نقشے پر {target} مقامات دیکھیں',
    icon: 'Globe3D',
    color: '#0EA5E9',
    targets: [1, 2, 3],
    xpReward: [10, 15, 25],
  },
  {
    ...
    descriptionAr: 'راجع {target} آيات',
    descriptionUr: '{target} آیات دہرائیں',
    icon: 'Brain',
    color: '#EC4899',
    targets: [3, 5, 10],
    xpReward: [10, 20, 35],
  },
  {
    ...
    name: 'Seek Guidance',
    nameAr: 'طلب الهداية',
    nameUr: 'ہدایت طلب کریں',
    description: 'Ask the AI Companion for guidance',
    descriptionAr: 'اسأل المرشد الذكي للإرشاد',
    descriptionUr: 'AI ساتھی سے رہنمائی لیں',
    icon: 'HeartHandshake',
    color: '#14B8A6',
    targets: [1],
    xpReward: [10],
  },
  {
    ...
    name: 'Spread Light',
    nameAr: 'نشر النور',
    nameUr: 'روشنی پھیلائیں',
    description: 'Share a verse with someone',
    descriptionAr: 'شارك آية مع شخص ما',
    descriptionUr: 'کسی کے ساتھ آیت شیئر کریں',
    icon: 'Share',
    color: '#10B981',
    targets: [1],
    xpReward: [10],
  },
  {
    ...
    descriptionAr: 'أنشئ كبسولة زمنية',
    descriptionUr: 'ایک ٹائم کیپسول بنائیں',
    icon: 'Capsule',
    color: '#F472B6',
    targets: [1],
    xpReward: [15],
...
export const generateDailyChallenges = () => {
  ...
  const challenges = selected.map((template) => {
    ...
    const targetVal = template.targets[targetIndex];
    return {
      id: `${template.id}_${Date.now()}`,
      templateId: template.id,
      name: template.name,
      nameAr: template.nameAr,
      nameUr: template.nameUr || template.name,
      description: template.description.replace('{target}', targetVal),
      descriptionAr: (template.descriptionAr || template.description).replace('{target}', targetVal),
      descriptionUr: (template.descriptionUr || template.description).replace('{target}', targetVal),
      icon: template.icon,

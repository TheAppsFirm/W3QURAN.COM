...
export const ONTOLOGY = {
  ...
  categories: {
    ...
    tawheedAndShirk: {
      ...
      nameUr: "توحید بمقابلہ شرک",
      nameArabic: "التوحيد والشرك",
      nameUr: "توحید اور شرک",
      concepts: [

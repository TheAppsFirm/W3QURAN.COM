        ...
        <div className="flex items-center gap-4 mt-3 pt-3 border-t border-white/5">
          ...
          {post.isLocked && (
            <div className="flex items-center gap-1 text-yellow-500/60 text-xs">
              ...
              <span>{t('discussions.lockedLabel', 'Locked')}</span>
            </div>
          )}
            ...
            <div className="ml-auto relative" onClick={e => e.stopPropagation()}>
              ...
              {showMenu && (
                <>
                  ...
                  <div className="absolute right-0 bottom-full mb-1 z-20 w-40 max-w-[calc(100vw-2rem)] rounded-xl bg-slate-800 border border-white/10 shadow-xl shadow-black/30 overflow-hidden py-1">
                    {isOwner && (
                      <button
                    ...
                    {isAdmin && (
                      ...
                      >
                        ...
                        {post.isPinned ? t('discussions.unpin', 'Unpin') : t('discussions.pin', 'Pin')}
                      </button>
                    )}
                    {isAdmin && (
                      <button
                      ...
                      >
                        ...
                        {post.isLocked ? t('discussions.unlock', 'Unlock') : t('discussions.lock', 'Lock')}
                      </button>
                    )}
                    <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={(e) => { e.stopPropagation(); setShowDeleteModal(false); }}>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-white font-semibold text-lg mb-1">{t('discussions.deletePostQuestion', 'Delete Post?')}</h3>
              <p className="text-sm text-white/40 mb-6">
                {t('discussions.deletePostMessage', 'This action cannot be undone. Your post will be permanently removed.')}
              </p>

        ...
        <div className="mt-2 p-3 rounded-xl bg-amber-500/[0.04] border border-amber-500/15 space-y-2.5">
          ...
          <div className="flex gap-2">
            ...
            <input
              ...
              placeholder="Ayah"
              className="w-20 px-2 py-1.5 rounded-lg bg-white/5 border border-white/10 text-white text-xs focus:outline-none"
            />
          </div>
          ...
          <div className="flex gap-2">
            ...
            >
              {quoteLoading ? t('discussions.loading', 'Loading...') : t('discussions.previewVerse', 'Preview')}
            </button>
            <button
              type="button"
              onClick={insertQuote}
            ...
            >
              {t('discussions.insertQuote', 'Insert')}
            </button>
          </div>

...
const SORT_OPTIONS = [
  { id: 'hot', label: 'Hot' },
  { id: 'new', label: 'New' },
  { id: 'top_week', label: 'Week' },
  { id: 'top_month', label: 'Month' },
      ...
      {activeTab === 'discussions' && (
        <>
          ...
          <div className="flex items-center gap-1 overflow-x-auto pb-1">
            <span className="text-xs text-white/30 mr-1 shrink-0">Sort:</span>
            {SORT_OPTIONS.map(s => (
              <button
                key={s.id}
          ...
          {/* Type filters */}
          <div className="flex items-center gap-1 overflow-x-auto pb-1">
            <span className="text-xs text-white/30 mr-1 shrink-0">Type:</span>
            {TYPE_FILTERS.map(t => (
              <button
                key={t.id}
          ...
          {loading && posts.length === 0 ? (
            ...
            <div className="text-center py-12 rounded-xl border border-white/5 bg-white/[0.02]">
              ...
              <p className="text-sm text-white/30">No discussions yet</p>

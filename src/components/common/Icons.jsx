/**
 * Icon Components
 * Single Responsibility: Provide SVG icons
 *
 * All icons accept standard SVG props (className, style, etc.)
...
// Filled icon wrapper
const FilledIcon = ({ children, className = 'w-5 h-5', ...props }) => (
...
export const LoaderIcon = (props) => (
  <Icon {...props} className={`${props.className || 'w-5 h-5'} animate-spin`}>
...
// Puzzle piece icon (alternative for Kids mode)

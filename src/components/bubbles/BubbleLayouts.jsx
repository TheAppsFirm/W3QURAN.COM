  ...
  return (
    <div
      ...
      style={{
        ...
        paddingRight: isMobile ? '40px' : '56px', // Minimal space for right side menu
...
export const JuzzGroupLayout = memo(function JuzzGroupLayout({
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 pr-10 sm:pr-12 pb-28 sm:pb-32 space-y-4 sm:space-y-6">
...
export const RevelationLayout = memo(function RevelationLayout({
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 pr-10 sm:pr-12 pb-28 sm:pb-32 space-y-6 sm:space-y-8">
      {/* Makki Period */}
      <div>
        <div
...
export const BookLayout = memo(function BookLayout({
  ...
  return (
    <div className="relative min-h-[70vh] sm:min-h-[80vh] w-full flex flex-col items-center pt-4 sm:pt-8 pb-28 sm:pb-32 pr-10 sm:pr-12 px-2 sm:px-4">
      {/* Header */}
...
export const ListLayout = memo(function ListLayout({
  ...
  return (
    <div className="p-2 sm:p-4 pr-10 sm:pr-12 pb-28 sm:pb-32 max-w-3xl mx-auto" dir="rtl">
...
export const CompactLayout = memo(function CompactLayout({
  ...
  return (
    <div className="p-2 sm:p-4 pr-10 sm:pr-12 pb-28 sm:pb-32" dir="rtl">
...
export const HoneycombLayout = memo(function HoneycombLayout({
  ...
  return (
    <div className="p-6 pr-10 sm:pr-12 pb-28 sm:pb-32 flex justify-center" dir="rtl">
...
export const WaveLayout = memo(function WaveLayout({
  ...
  return (
    <div className="p-6 pr-10 sm:pr-12 pb-28 sm:pb-32 overflow-x-auto" dir="rtl">
...
export const LengthLayout = memo(function LengthLayout({
  ...
  return (
    <div className="p-4 pr-10 sm:pr-12 pb-28 sm:pb-32" dir="rtl">
...
export const KidsLayout = memo(function KidsLayout({
  ...
  return (
    <div className="p-4 sm:p-6 pr-10 sm:pr-12 pb-28 sm:pb-32" dir="rtl">
      {/* Fun header for kids */}
...
export const ArtLayout = memo(function ArtLayout({
  ...
  return (
    <div className="p-4 sm:p-6 pr-10 sm:pr-12 pb-28 sm:pb-32" dir="rtl" style={{
      background: darkMode

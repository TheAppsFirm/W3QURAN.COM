...
const Header = memo(function Header({ filters, setFilters, showAnalytics, setShowAnalytics, onSettingsClick, onAdminClick, onUpgradeClick }) {
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap">
          ...
          <div className={isRTL ? 'mr-2' : 'ml-2'}>
            {authLoading ? (
              ...
              <UserMenu onSettingsClick={onSettingsClick} onAdminClick={onAdminClick} onUpgradeClick={onUpgradeClick} />
            ) : (
              <LoginButton compact />
            )}
          </div>

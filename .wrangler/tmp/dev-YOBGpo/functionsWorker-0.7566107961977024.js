...
// .wrangler/tmp/bundle-MubJV0/checked-fetch.js
...
// .wrangler/tmp/pages-HRKUBM/functionsWorker-0.7566107961977024.mjs
...
__name(fetchWords, "fetchWords");
__name2(fetchWords, "fetchWords");
async function onRequest(context) {
  ...
  try {
    ...
    data.verses?.forEach((verse) => {
      ...
      wordsMap[verseNum] = verse.words?.filter((w) => w.char_type_name === "word")?.map((w) => ({
...
// .wrangler/tmp/bundle-MubJV0/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-MubJV0/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7566107961977024.js.map
